...
public struct LiquidGlassBackground<Content: View>: NSViewRepresentable {
    ...
    public func makeNSView(context: Context) -> NSView {
        ...
        if let glassType = NSClassFromString("NSGlassEffectView") as? NSView.Type {
            print("✓ LiquidGlassBackground: Using NSGlassEffectView with variant \(variant.rawValue)")
        ...
        print("✗ LiquidGlassBackground: NSGlassEffectView not found, using fallback")
        let fallback = NSVisualEffectView()
        fallback.material = .hudWindow // More visible than underWindowBackground
